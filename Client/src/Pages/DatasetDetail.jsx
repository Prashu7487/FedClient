...
const DatasetDetail = () => {
    ...
    const getChartData = () => {
        if (!selectedBenchmark || !selectedBenchmark.metrics[selectedMetric]) return null;
    ...
    if (loading) {
        return <p className="text-center text-gray-500">Loading dataset details...</p>;
    }
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto bg-gray-100 shadow-lg rounded-lg">
            {/* Dataset Header */}
            <div className="mb-6">
                <h1 className="text-4xl font-bold text-gray-800 mb-4">{dataset.name}</h1>
            ...
            {selectedBenchmark && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-lg max-w-lg w-full relative shadow-lg">
                        ...
                        <h3 className="text-xl font-bold mb-4">Metrics for {selectedBenchmark.task}</h3>
                        <select
